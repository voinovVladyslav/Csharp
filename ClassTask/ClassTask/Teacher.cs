...
namespace ClassTask
{
    class Teacher : Human
    {
        ...
        public void RemoveStudent(Student student) { if (limitCounter == 0) { Console.WriteLine("There is no one to remove"); } else { students.Remove(student); limitCounter--; Console.WriteLine("Succsesfuly removed student"); } }
    }
}
